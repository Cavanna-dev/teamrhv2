...
$id_client_contact = $_GET['id_client'];

$r_client = getOneCustomerById($db, $id_client_contact);
?>

<div class="container">
    <h1>Ajout Contact pour <a href="upd_client.php?id=<?= $r_client->id ?>"><?= $r_client->nom ?></a></h1>
    <form class="form-horizontal" method="POST" action="../functions/new_contact.php" id="form_rdv">
        <input type="hidden" name="client" value="<?= $r_client->id ?>" />
        <div class="jumbotron">
            <div class="row">
                <div class="col-lg-6">
                    <fieldset>
