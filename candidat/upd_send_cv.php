...
<div class="container" style="font-size: 8px!important;">
    ...
    <form class="form-horizontal" method="POST" action="../functions/upd_send_cv.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input class="form-control" type="date" 
                                       ...
                                       value="<?= date("Y-m-d", strtotime($_GET['date_envoi'])) ?>"/>
                            </div>
                        </div>
                    </fieldset>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
         ...
         */
        $('#cible_client_right').find('option').each(function () {
            $('#cible_client_left option[value="' + $(this).val() + '"]').remove();
        });
         ...
         */
        $('#cible_poste_right').find('option').each(function () {
            $('#cible_poste_left option[value="' + $(this).val() + '"]').remove();
        });
        $('#add_item_job').click(function () {
            ...
            if (id != '' && right != '')
                ...
                alert('Veuillez selectionner un poste à gauche pour l\'ajouter.');
        ...
        $('#rmv_item_job').click(function () {
            ...
            if (id != '' && right != '')
                ...
                alert('Veuillez selectionner un poste à droite pour le supprimer.');
         ...
         */
        $('#cible_prosp_right').find('option').each(function () {
            $('#cible_prosp_left option[value="' + $(this).val() + '"]').remove();
        });
