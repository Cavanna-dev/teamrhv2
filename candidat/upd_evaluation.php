...
<div class="container">
    <?php if (isset($_GET['success'])) { ?>
        <div class="alert alert-dismissible alert-success" id="show-up" style="display:none;">
            ...
            L'évaluation a bien été modifié.
        </div>
    <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        <input class="form-control" type="text"
                                               ...
                                               value="<?= isset($r->LVL_TYPE) ? $r->LVL_TYPE : '' ?>"/>
                                    </div>
                                    <label for="input_note" class="col-lg-2 control-label">Note Langue</label>
                                    <div class="col-lg-2">
                                        <input class="form-control" type="number" 
                                               name="input_note" id="input_note"
                                               placeholder="Note"
                                               value="<?= isset($r->LVL_NOTE) ? $r->LVL_NOTE : '' ?>"/>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" type="text" 
                                               ...
                                               value="<?= isset($r->AUTRE_APPLI2) ? $r->AUTRE_APPLI2 : '' ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" type="text" 
                                               ...
                                               value="<?= isset($r->SOCIETE_RECH) ? $r->SOCIETE_RECH : '' ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" 
                                            ...
                                            <option value="" <?= $r->WORD == '' ? 'selected' : '' ?>></option>
                                            <option value="A" <?= $r->WORD == 'A' ? 'selected' : '' ?>>A</option>
                                            <option value="B" <?= $r->WORD == 'B' ? 'selected' : '' ?>>B</option>
                                            <option value="C" <?= $r->WORD == 'C' ? 'selected' : '' ?>>C</option>
                                            <option value="D" <?= $r->WORD == 'D' ? 'selected' : '' ?>>D</option>
                                            <option value="N/A" <?= $r->WORD == 'N/A' ? 'selected' : '' ?>>N/A</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" 
                                            ...
                                            <option value="" <?= $r->EXCEL == '' ? 'selected' : '' ?>></option>
                                            <option value="A" <?= $r->EXCEL == 'A' ? 'selected' : '' ?>>A</option>
                                            <option value="B" <?= $r->EXCEL == 'B' ? 'selected' : '' ?>>B</option>
                                            <option value="C" <?= $r->EXCEL == 'C' ? 'selected' : '' ?>>C</option>
                                            <option value="D" <?= $r->EXCEL == 'D' ? 'selected' : '' ?>>D</option>
                                            <option value="N/A" <?= $r->EXCEL == 'N/A' ? 'selected' : '' ?>>N/A</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <select class="form-control" 
                                            ...
                                            <option value="" <?= $r->POWERPOINT == '' ? 'selected' : '' ?>></option>
                                            <option value="A" <?= $r->POWERPOINT == 'A' ? 'selected' : '' ?>>A</option>
                                            <option value="B" <?= $r->POWERPOINT == 'B' ? 'selected' : '' ?>>B</option>
                                            <option value="C" <?= $r->POWERPOINT == 'C' ? 'selected' : '' ?>>C</option>
                                            <option value="D" <?= $r->POWERPOINT == 'D' ? 'selected' : '' ?>>D</option>
                                            <option value="N/A" <?= $r->POWERPOINT == 'N/A' ? 'selected' : '' ?>>N/A</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" 
                                               ...
                                               value="<?= isset($r->MOBILITE) ? $r->MOBILITE : '' ?>"/>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control" 
                                               ...
                                               value="<?= isset($r->SOCIETE_ACTUEL) ? $r->SOCIETE_ACTUEL : '' ?>"/>
                                    </div>
                                </div>
                                <div class="form-group">
