                    ...
                    <B>Connexion impossible &agrave; notre base de donn&eacute;es. Renouveller votre recherche ult&eacute;rieurement.<B>
                        ...
                        <TR>
                            ...
                            <TD align="left"  class="normal" colspan="5">
                                ...
                                $ord1 = urlencode("3, 4")
                                ?>
                                <A class="lien"  href="#" onclick="location.href = 'placement.php?&param=<?= $tmp1; ?>&order=<?= $ord1; ?>';">Class&eacute; par mois</A>
                            </TD>
                            <TD align="right"  class="normal"  colspan="5">
                                ...
                                $ord2 = urlencode("4, 3")
                                ?>
                                <A class="lien"  href="#" onclick="location.href = 'placement.php?&param=<?= $tmp1; ?>&order=<?= $ord2; ?>';">Class&eacute; par client</A>
                            </TD>
                            <TD colspan="3">
                                &nbsp;
                            </TD>
