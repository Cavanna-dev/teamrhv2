...
$r = getOneContactProspectById($db, $id);
$r_prospect = getOneProspectById($db, $r->prospect);
?>

<div class="container">
    <h1>Fiche Contact - <a href="upd_prospect.php?id=<?= $r_prospect->id ?>"><?= $r_prospect->nom ?></a></h1>
    <form class="form-horizontal" method="POST" action="../functions/upd_contact_prospect.php" id="form_rdv">
